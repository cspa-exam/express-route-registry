...
class RouteRegistry extends ContainerAware {
  constructor() {
    super();
    this.routes = [];
    this.routes_by_name = {};
        ...
        const route = (() => {
          ...
          // Type 2: It's an array with 2 elements.
            ...
            if ('string' === typeof route_destination[0]) {
              const service = this.get(route_destination[0]);
          ...
          // Type 3: It's a configuration object with keys
            ...
            if ('service_id' in route_destination) {
              if (!this.container) {
               throw new RouteRegistryError('route_registry_container_missing', 'Container not yet initialized.');
              }
